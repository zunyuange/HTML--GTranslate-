(function(){
    ...
    var flags_location = gt.flags_location||'https://cdn.zunyuange.link/flags/';
    ...
    widget_css += '.gt_float_switcher{font-family:Arial;font-size:20px;border-radius:2px;transform: translateY(-35px);color:#555;display:inline-block;line-height:20px;box-shadow:rgba(0,0,0,0.15) 0 5px 15px;background:#fff;overflow:hidden;transition:all .5s cubic-bezier(0.4, 0, 1, 1)}';
    widget_css += '.gt_float_switcher img{vertical-align:middle;display:inline-block;width:20px;height:auto;margin:0 5px 0 0;border-radius:3px}';
    if(float_switcher_open_direction == 'left' || float_switcher_open_direction == 'right') {
        ...
        widget_css += '.gt_float_switcher .gt_options a{display:inline-block;text-decoration:none;padding:'+(flag_style=='3d'?6:1)+'px 15px;color:#444;transition:color .4s linear}';
        ...
        widget_css += '.gt_float_switcher .gt_options a{display:block;text-decoration:none;padding:'+(flag_style=='3d'?6:1)+'px 15px;color:#444;transition:color .4s linear}';
    ...
    widget_css += '.gt_float_switcher .gt-selected .gt-current-lang{padding:'+(flag_style=='3d'?6:1)+'px 15px;color:#333;font-weight:bold}';
    ...
    if(switcher_horizontal_position == 'inline')
        ...
        widget_code += '<div id="gt_float_wrapper" style="/* position: fixed; */position: relative;'+switcher_vertical_position+':-80px;'+switcher_horizontal_position+':5px;z-index:999999;"><div class="gt_float_switcher notranslate" style="opacity:0">';
